...
// ─── Users ──────────────────────────────────────────────────────────────────
// NOTE: All passwords below are "password" — FOR LOCAL TESTING / DEMO ONLY.
// Never ship plaintext passwords in production code.
...
export const MOCK_CURRENT_ADMIN: UserProfile = {
  id: "u6",
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Textbook was exactly as described. Thandi was super helpful and even met me at the library. Highly recommend!",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Phone works great, delivery was a bit slow but the seller communicated well throughout.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Prof. van Wyk is a legend. Drawing board was in perfect condition. Thank you!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Brand new as promised. Campus Tech is legit — fast delivery and great packaging.",
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Good tutoring session, really helped me understand recursion. Will book again.",
...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    ...
    listing_id: "l1",
    last_message:
      "Hi! The textbook is ready for collection at the library entrance.",
